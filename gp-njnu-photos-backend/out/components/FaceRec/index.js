...
const _default = class extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: css.content, ref: r => this.container = r },
                React.createElement('video', { ref: r => this.video = r, preload: true, autoPlay: true, loop: true, muted: true }),
                React.createElement('canvas', { style: { display: '' }, ref: r => this.canvas = r }),
                React.createElement('canvas', { style: { display: 'none' }, ref: r => this.data_canvas = r })
            )
        );
    }
};
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(worker, 'worker', '../gp-njnu-photos-app/app/components/FaceRec/index.js');

    __REACT_HOT_LOADER__.register(tracking, 'tracking', '../gp-njnu-photos-app/app/components/FaceRec/index.js');

    __REACT_HOT_LOADER__.register(_default, 'default', '../gp-njnu-photos-app/app/components/FaceRec/index.js');
}();
