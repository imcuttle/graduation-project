...
renderer.listitem = function (text) {
    if (/^\s*\[[x ]\]\s*/.test(text)) {
        text = text.replace(/^\s*\[ \]\s*/, '<input style="vertical-align: middle;" type="checkbox" disabled/> ').replace(/^\s*\[x\]\s*/, '<input style="vertical-align: middle;" type="checkbox" checked="true" disabled/> ');
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(renderer, 'renderer', '../gp-njnu-photos-app/app/reducers/about.js');

    __REACT_HOT_LOADER__.register(markdown, 'markdown', '../gp-njnu-photos-app/app/reducers/about.js');

    __REACT_HOT_LOADER__.register(initState, 'initState', '../gp-njnu-photos-app/app/reducers/about.js');

    __REACT_HOT_LOADER__.register(_default, 'default', '../gp-njnu-photos-app/app/reducers/about.js');
}();
