...
const _default = function (state = initState, action) {
    ...
    switch (action.type) {
        case 'PUSH_ROUTE':
            return _extends({}, newState, getNewRouteState(action.path));
        default:
            return newState;
    }
};
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(initState, "initState", "../gp-njnu-photos-app/app/reducers/active.js");

    __REACT_HOT_LOADER__.register(getNewRouteState, "getNewRouteState", "../gp-njnu-photos-app/app/reducers/active.js");

    __REACT_HOT_LOADER__.register(_default, "default", "../gp-njnu-photos-app/app/reducers/active.js");
}();
